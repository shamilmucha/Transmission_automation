...
This will check if there are any active torrents, if there are none no shutdown will initiate.

As prerequisite this script need to install the latest python version on your desktop and transmission as the default torrent client. You can use Cronjob to schedule it everyday starts at 12 AM.
